...
describe('config loader', () => {
  ...
  test('DEFAULT_CONFIG has correct default values', () => {
    ...
    expect(DEFAULT_CONFIG.bookmarks.thresholds.minTokens).toBe(10000)
    expect(DEFAULT_CONFIG.bookmarks.thresholds.minToolCalls).toBe(15)
    expect(DEFAULT_CONFIG.bookmarks.thresholds.minSeconds).toBe(300)
    expect(DEFAULT_CONFIG.bookmarks.thresholds.agentBurstThreshold).toBe(5)
    expect(DEFAULT_CONFIG.bookmarks.thresholds.cooldownSeconds).toBe(30)
  })
})
